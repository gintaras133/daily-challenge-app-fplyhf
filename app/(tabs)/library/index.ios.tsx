        ...
        >
          ...
          <View style={styles.header}>
            <TouchableOpacity style={styles.menuButton}>
              <IconSymbol ios_icon_name="line.3.horizontal" size={28} color="#000000" />
            </TouchableOpacity>

            <View style={styles.titleSection}>
              <IconSymbol ios_icon_name="play.rectangle.on.rectangle.fill" size={32} color="#ffffff" />
            ...
            <View key={index} style={styles.challengeCard}>
              ...
              <View style={styles.thumbnailContainer}>
                <View style={styles.thumbnail}>
                  <IconSymbol ios_icon_name="play.fill" size={48} color="#ffffff" />
                </View>
                {challenge.isWinner && (
                  <View style={styles.winnerBadge}>
                    <IconSymbol ios_icon_name="trophy.fill" size={16} color="#ffffff" />
                  </View>
                )}
              ...
              <View style={styles.challengeDetails}>
                <View style={styles.dateRow}>
                  <IconSymbol ios_icon_name="calendar" size={14} color="#666666" />
                ...
                <View style={styles.statsRow}>
                  <View style={styles.statItem}>
                    <IconSymbol ios_icon_name="heart.fill" size={16} color="#ff6b6b" />
                    <Text style={styles.statItemText}>{challenge.likes}</Text>
                  </View>
                  <View style={styles.statItem}>
                    <IconSymbol ios_icon_name="eye.fill" size={16} color="#666666" />
                ...
                <View style={styles.actionButtons}>
                  ...
                  <TouchableOpacity style={styles.iconButton}>
                    <IconSymbol ios_icon_name="arrow.down.circle" size={20} color="#666666" />
                  </TouchableOpacity>
                  <TouchableOpacity style={styles.iconButton}>
                    <IconSymbol ios_icon_name="trash" size={20} color="#ff6b6b" />
                  </TouchableOpacity>
                </View>
              </View>
            </View>
          ...
          >
            <IconSymbol ios_icon_name="arrow.left" size={20} color="#ffffff" />
