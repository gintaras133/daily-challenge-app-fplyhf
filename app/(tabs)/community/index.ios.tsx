      ...
      >
        ...
        <View style={styles.header}>
          <View style={styles.headerIcon}>
            <IconSymbol ios_icon_name="person.2.fill" android_material_icon_name="people" size={28} color="#ffffff" />
          </View>
            ...
            <View style={styles.videoInfo}>
              ...
              <View style={styles.videoStats}>
                <View style={styles.statItem}>
                  <IconSymbol ios_icon_name="heart.fill" android_material_icon_name="favorite" size={16} color="#ff6b6b" />
                  <Text style={styles.statText}>{video.likes}</Text>
                </View>
                <View style={styles.statItem}>
                  <IconSymbol ios_icon_name="eye.fill" android_material_icon_name="visibility" size={16} color="#666666" />
